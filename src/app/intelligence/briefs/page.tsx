      ...
      <section className="container section vt-section">
        <div className="mb-6">
          ...
          >
	        ...
	        <SectionHeader 
	          kicker="Strategic Briefs" 
	          title="All Strategic Briefs" 
	          subtitle="Complete archive of strategic analysis and market insights." 
	          useGradientTitle 
	        />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {briefs.map((brief) => (
	          ...
	          <div className="text-center py-12">
	            <p className="text-[hsl(var(--muted-foreground))]">No strategic briefs available yet.</p>
