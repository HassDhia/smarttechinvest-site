  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-3 mb-4 text-white/80">
        <div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-[color-mix(in_srgb,_hsl(var(--foreground))_15%,_transparent)] border border-[color-mix(in_srgb,_hsl(var(--foreground))_30%,_transparent)]">
